...
public final class GenesisMod {
    ...
    public GenesisMod(IEventBus eventBus, ModContainer modContainer) {
        ...
        eventBus.addListener(GenesisNetworking::register);
        ...
        eventBus.addListener(shipwrights.genesis.content.blockentity.GenesisBlockEntities::registerCapabilities);
        shipwrights.genesis.content.sound.GenesisSounds.SOUND_EVENTS.register(eventBus);
        shipwrights.genesis.content.entity.GenesisEntities.register(eventBus);
        shipwrights.genesis.worldgen.GenesisPlacementModifiers.register(eventBus);
        ...
        // Orbit-to-land and launch-to-orbit: contact with a rendered planet in
        // space drops you (and your ship) into its dimension; climbing above the
        // atmosphere lifts you back into space.
        NeoForge.EVENT_BUS.register(new shipwrights.genesis.teleportation.integration.SpaceToPlanetTeleporter(false));
        NeoForge.EVENT_BUS.register(new shipwrights.genesis.teleportation.integration.PlanetToSpaceTeleporter(false));
    }
