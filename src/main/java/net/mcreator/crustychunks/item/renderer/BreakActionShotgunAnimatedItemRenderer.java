...
import net.mcreator.crustychunks.item.model.BreakActionShotgunAnimatedItemModel;
...
public class BreakActionShotgunAnimatedItemRenderer extends GeoItemRenderer<BreakActionShotgunAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected BreakActionShotgunAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public BreakActionShotgunAnimatedItemRenderer() {
      super(new BreakActionShotgunAnimatedItemModel());
   }

   public RenderType getRenderType(BreakActionShotgunAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(BreakActionShotgunAnimatedItem instance) {
