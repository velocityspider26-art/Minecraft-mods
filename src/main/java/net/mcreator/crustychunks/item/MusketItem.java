...
import net.mcreator.crustychunks.item.renderer.MusketItemRenderer;
import net.mcreator.crustychunks.procedures.AmmoCount1Procedure;
import net.mcreator.crustychunks.procedures.MusketActionProcedure;
import net.mcreator.crustychunks.procedures.MusketFireScriptProcedure;
...
public class MusketItem extends Item implements GeoItem {
   ...
   public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
      consumer.accept(new GeoRenderProvider() {
         private MusketItemRenderer renderer;

         @Override
         public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
            if (this.renderer == null)
               this.renderer = new MusketItemRenderer();
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
               return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? (ArmPose) net.mcreator.crustychunks.client.pose.MusketItemPose.ARM_POSE.getValue() : ArmPose.EMPTY;
            }
   ...
   public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
      ...
      MusketFireScriptProcedure.execute(world, x, y, z, entity, itemstack);
      return ar;
   }
   ...
   public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
      ...
      MusketActionProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
      return retval;
   }
}
