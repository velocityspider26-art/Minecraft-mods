...
import net.mcreator.crustychunks.procedures.ArmorBypassTinyProcedure;
...
public class TinyprojectileEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModItems.TINYPROJECTILE_ITEM.get());

   public TinyprojectileEntity(EntityType<? extends TinyprojectileEntity> type, Level world) {
      super(type, world);
   }
   ...
   public void onHitEntity(EntityHitResult entityHitResult) {
      ...
      ArmorBypassTinyProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity(), this, this.getOwner());
   }
   ...
   public static TinyprojectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
      return shoot(world, entity, source, 1.0F, 5.0, 5);
   }

   public static TinyprojectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
      return shoot(world, entity, source, pullingPower * 1.0F, 5.0, 5);
   }

   public static TinyprojectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      TinyprojectileEntity entityarrow = new TinyprojectileEntity(
         (EntityType<? extends TinyprojectileEntity>)CrustyChunksModEntities.TINYPROJECTILE.get(), entity, world
      );
   ...
   public static TinyprojectileEntity shoot(LivingEntity entity, LivingEntity target) {
      TinyprojectileEntity entityarrow = new TinyprojectileEntity(
         (EntityType<? extends TinyprojectileEntity>)CrustyChunksModEntities.TINYPROJECTILE.get(), entity, entity.level()
      );
