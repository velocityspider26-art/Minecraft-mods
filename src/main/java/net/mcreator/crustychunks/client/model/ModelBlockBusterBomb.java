...
public class ModelBlockBusterBomb<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("crusty_chunks", "model_block_buster_bomb"), "main");
   ...
   public ModelBlockBusterBomb(ModelPart root) {
      this.SuperHeavyBomb = root.getChild("SuperHeavyBomb");
      this.CoreAddition = this.SuperHeavyBomb.getChild("CoreAddition");
      this.Warhead = this.SuperHeavyBomb.getChild("Warhead");
      this.Fins = this.SuperHeavyBomb.getChild("Fins");
      this.Core = this.SuperHeavyBomb.getChild("Core");
   }

   public static LayerDefinition createBodyLayer() {
      MeshDefinition meshdefinition = new MeshDefinition();
      PartDefinition partdefinition = meshdefinition.getRoot();
      PartDefinition SuperHeavyBomb = partdefinition.addOrReplaceChild(
         "SuperHeavyBomb", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 24.0F, -8.0F, -1.5708F, 0.0F, 0.0F)
      );
      PartDefinition CoreAddition = SuperHeavyBomb.addOrReplaceChild(
         "CoreAddition",
         CubeListBuilder.create()
            .texOffs(58, 65)
            .addBox(-12.0F, -12.0F, 0.0F, 12.0F, 12.0F, 16.0F, new CubeDeformation(0.0F))
            .texOffs(58, 65)
            .addBox(-12.0F, -12.0F, 32.0F, 12.0F, 12.0F, 16.0F, new CubeDeformation(0.0F)),
         PartPose.offset(6.0F, -2.0F, -24.0F)
      );
      PartDefinition Warhead = SuperHeavyBomb.addOrReplaceChild(
         "Warhead",
         CubeListBuilder.create()
            .texOffs(2, 67)
      ...
      PartDefinition Fins = SuperHeavyBomb.addOrReplaceChild(
         "Fins",
         CubeListBuilder.create()
            .texOffs(0, 28)
         ...
         PartPose.offset(1.0F, -16.0F, 26.0F)
      );
      PartDefinition Core = SuperHeavyBomb.addOrReplaceChild(
         "Core",
         CubeListBuilder.create()
            .texOffs(0, 0)
   ...
   public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
      this.SuperHeavyBomb.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
   }
}
