...
import net.mcreator.crustychunks.item.model.FlameThrowerAnimatedItemModel;
...
public class FlameThrowerAnimatedItemRenderer extends GeoItemRenderer<FlameThrowerAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected FlameThrowerAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public FlameThrowerAnimatedItemRenderer() {
      super(new FlameThrowerAnimatedItemModel());
   }

   public RenderType getRenderType(FlameThrowerAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(FlameThrowerAnimatedItem instance) {
