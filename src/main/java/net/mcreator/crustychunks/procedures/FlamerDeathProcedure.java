...
public class FlamerDeathProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      ...
      if (entity != null) {
         ...
         CrustyChunksMod.queueServerWork(
            ...
            () -> {
               for (int index0 = 0; index0 < 3; index0++) {
                  ...
                  if (world instanceof ServerLevel _level) {
                     ItemEntity entityToSpawn = new ItemEntity(
                        _level, x + 0.5, y + 1.0, z + 0.5, new ItemStack((ItemLike)CrustyChunksModItems.BORED_COMPONENT.get())
                     );
                     entityToSpawn.setPickUpDelay(10);
                     _level.addFreshEntity(entityToSpawn);
                  }
               ...
               if (world instanceof ServerLevel _level) {
                  ItemEntity entityToSpawn = new ItemEntity(
                     _level, x + 0.5, y + 1.0, z + 0.5, new ItemStack((ItemLike)CrustyChunksModBlocks.FLAME_THROWER.get())
                  );
                  entityToSpawn.setPickUpDelay(10);
                  _level.addFreshEntity(entityToSpawn);
               }
               ...
               if (world instanceof ServerLevel _level) {
                  ItemEntity entityToSpawn = new ItemEntity(
                     _level, x + 0.5, y + 1.0, z + 0.5, new ItemStack((ItemLike)CrustyChunksModBlocks.FLAME_THROWER_BARREL.get())
                  );
                  entityToSpawn.setPickUpDelay(10);
                  _level.addFreshEntity(entityToSpawn);
               }
         ...
         net.mcreator.crustychunks.compat.WariumSafety.report("FlamerDeathProcedure.execute", _wtSafe);
      }
   }
}
