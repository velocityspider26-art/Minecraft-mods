...
public class ModelNVDHelmet<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("crusty_chunks", "model_nvd_helmet"), "main");
   public final ModelPart group;

   public ModelNVDHelmet(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition group = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .mirror(false)
            .texOffs(52, 0)
            .addBox(-3.0F, -5.0F, -8.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(52, 0)
            .addBox(1.0F, -5.0F, -8.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(18, 0)
            .addBox(-2.0F, -7.0F, -6.5F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
