...
import net.mcreator.crustychunks.entity.layer.StrikerLayer;
import net.mcreator.crustychunks.entity.model.StrikerModel;
...
public class StrikerRenderer extends GeoEntityRenderer<StrikerEntity> {
   public StrikerRenderer(Context renderManager) {
      super(renderManager, new StrikerModel());
      this.shadowRadius = 0.5F;
      this.addRenderLayer(new StrikerLayer(this));
   }
