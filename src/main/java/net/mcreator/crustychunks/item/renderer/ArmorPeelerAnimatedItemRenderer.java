...
import net.mcreator.crustychunks.item.model.ArmorPeelerAnimatedItemModel;
...
public class ArmorPeelerAnimatedItemRenderer extends GeoItemRenderer<ArmorPeelerAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected ArmorPeelerAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public ArmorPeelerAnimatedItemRenderer() {
      super(new ArmorPeelerAnimatedItemModel());
   }

   public RenderType getRenderType(ArmorPeelerAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(ArmorPeelerAnimatedItem instance) {
