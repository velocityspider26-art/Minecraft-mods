...
public class ProtoEradicatorAIProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      ...
      if (entity != null) {
         ...
         if (entity.isAlive()) {
            ...
            if (entity.getDeltaMovement().x() != 0.0 && entity.getDeltaMovement().z() != 0.0) {
               for (int index0 = 0; index0 < 2; index0++) {
                  world.addParticle(
                     ...
                     x + Mth.nextDouble(RandomSource.create(), -1.5, 1.5),
                     y,
                     z + Mth.nextDouble(RandomSource.create(), -1.5, 1.5),
                     0.0,
                     0.0,
                     0.0
                  );
               ...
               if (world instanceof Level _levelx) {
                  if (!_levelx.isClientSide()) {
                     _levelx.playSound(
                        ...
                        SoundSource.NEUTRAL,
                        (float)(3.0 + rev),
                        (float)(Mth.nextDouble(RandomSource.create(), 0.8, 0.9) + rev)
                     );
                  } else {
            ...
            if ((entity instanceof LivingEntity _livEntx ? _livEntx.getHealth() : -1.0F)
               ...
               if (world instanceof ServerLevel _levelxx) {
                  _levelxx.sendParticles((SimpleParticleType)CrustyChunksModParticleTypes.HUGE_SPARKS.get(), x, y + 2.0, z, 2, 1.0, 1.0, 1.0, 1.0);
               }

               if (10 == Mth.nextInt(RandomSource.create(), 1, 80) && world instanceof Level _levelxx) {
         ...
         net.mcreator.crustychunks.compat.WariumSafety.report("ProtoEradicatorAIProcedure.execute", _wtSafe);
      }
   }
}
