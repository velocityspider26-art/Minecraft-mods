   ...
   if (capability != null) capability.extractEnergy(_amount, false);
         ...
         if (world instanceof Level _level) {
            if (!_level.isClientSide()) {
               _level.playSound(
                  ...
                  (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("block.lava.ambient")),
                  SoundSource.BLOCKS,
                  1.0F,
                  1.0F
               );
               ...
               _level.playLocalSound(
                  x, y, z, (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("block.lava.ambient")), SoundSource.BLOCKS, 1.0F, 1.0F, false
               );
            }
         }
         ...
         if (!world.isClientSide()) {
            ...
            if (_blockEntity != null) {
               ...
               }).getValue(world, BlockPos.containing(x + 1.0, y, z), "Heat") + 40.0);
            }
         ...
         if (!world.isClientSide()) {
            ...
            if (_blockEntityxx != null) {
               ...
               }).getValue(world, BlockPos.containing(x, y, z + 1.0), "Heat") + 40.0);
            }
         ...
         if (!world.isClientSide()) {
            ...
            if (_blockEntityxxxx != null) {
               ...
               }).getValue(world, BlockPos.containing(x, y + 1.0, z), "Heat") + 40.0);
            }
