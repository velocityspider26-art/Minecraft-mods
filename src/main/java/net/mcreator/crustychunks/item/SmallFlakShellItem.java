...
public class SmallFlakShellItem extends Item {
   public SmallFlakShellItem() {
   ...
   public void appendHoverText(ItemStack itemstack, net.minecraft.world.item.Item.TooltipContext level, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.translatable("item.crusty_chunks.small_flak_shell.description_0"));
   }
}
