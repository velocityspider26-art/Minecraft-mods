...
public class FissionBombGUIScreen extends AbstractContainerScreen<FissionBombGUIMenu> {
   private static final HashMap<String, Object> guistate = FissionBombGUIMenu.guistate;
   private final Level world;
   private final int x;
   private final int y;
   private final int z;
   private final Player entity;
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/screens/fission_bomb_gui.png");

   public FissionBombGUIScreen(FissionBombGUIMenu container, Inventory inventory, Component text) {
   ...
   protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
      guiGraphics.drawString(this.font, Component.translatable("gui.crusty_chunks.fission_bomb_gui.label_fission_bomb"), 6, 7, -12829636, false);
   }
