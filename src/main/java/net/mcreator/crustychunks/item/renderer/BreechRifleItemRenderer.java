...
import net.mcreator.crustychunks.item.model.BreechRifleItemModel;
...
public class BreechRifleItemRenderer extends GeoItemRenderer<BreechRifleItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected BreechRifleItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public BreechRifleItemRenderer() {
      super(new BreechRifleItemModel());
   }

   public RenderType getRenderType(BreechRifleItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(BreechRifleItem instance) {
