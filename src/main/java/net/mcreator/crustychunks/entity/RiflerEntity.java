...
import net.mcreator.crustychunks.procedures.RiflerAISystemProcedure;
import net.mcreator.crustychunks.procedures.RiflerdeathProcedure;
...
public class RiflerEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(RiflerEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(RiflerEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(RiflerEntity.class, EntityDataSerializers.STRING);
   ...
   public RiflerEntity(EntityType<RiflerEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(12, (new HurtByTargetGoal(this) {
         public boolean canUse() {
            double x = RiflerEntity.this.getX();
            double y = RiflerEntity.this.getY();
            double z = RiflerEntity.this.getZ();
            Entity entity = RiflerEntity.this;
            Level world = RiflerEntity.this.level();
   ...
   public void die(DamageSource source) {
      super.die(source);
      RiflerdeathProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public void baseTick() {
      super.baseTick();
      RiflerAISystemProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
