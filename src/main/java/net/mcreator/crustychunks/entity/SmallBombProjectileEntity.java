...
import net.mcreator.crustychunks.procedures.SmallBombTickProcedure;
...
public class SmallBombProjectileEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModBlocks.SMALL_BOMB.get());

   public SmallBombProjectileEntity(EntityType<? extends SmallBombProjectileEntity> type, Level world) {
      super(type, world);
   }
   ...
   public void onHitEntity(EntityHitResult entityHitResult) {
      ...
      SmallBombProjectileHitsBlockProcedure.execute(this.level(), this);
   }
   ...
   public void tick() {
      super.tick();
      SmallBombTickProcedure.execute(this.level(), this);
   }

   public static SmallBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
      return shoot(world, entity, source, 1.0F, 5.0, 5);
   }

   public static SmallBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
      return shoot(world, entity, source, pullingPower * 1.0F, 5.0, 5);
   }

   public static SmallBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      SmallBombProjectileEntity entityarrow = new SmallBombProjectileEntity(
         (EntityType<? extends SmallBombProjectileEntity>)CrustyChunksModEntities.SMALL_BOMB_PROJECTILE.get(), entity, world
      );
   ...
   public static SmallBombProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      SmallBombProjectileEntity entityarrow = new SmallBombProjectileEntity(
         (EntityType<? extends SmallBombProjectileEntity>)CrustyChunksModEntities.SMALL_BOMB_PROJECTILE.get(), entity, entity.level()
      );
