...
import net.mcreator.crustychunks.procedures.EradicatorAIProcedure;
import net.mcreator.crustychunks.procedures.EradicatorDamagedProcedure;
import net.mcreator.crustychunks.procedures.EradicatorDeathProcedure;
...
public class EradicatorEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(EradicatorEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(EradicatorEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(EradicatorEntity.class, EntityDataSerializers.STRING);
   ...
   public EradicatorEntity(EntityType<EradicatorEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
      this.getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.STEP_HEIGHT).setBaseValue(5.0F);
   ...
   protected void defineSynchedData(SynchedEntityData.Builder builder) {
      ...
      builder.define(TEXTURE, "eradicator");
   }
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(8, (new HurtByTargetGoal(this) {
         public boolean canUse() {
            double x = EradicatorEntity.this.getX();
            double y = EradicatorEntity.this.getY();
            double z = EradicatorEntity.this.getZ();
            Entity entity = EradicatorEntity.this;
            Level world = EradicatorEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      EradicatorAIProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   protected void tickDeath() {
      ...
      if (this.deathTime == 160) {
         ...
         EradicatorDeathProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
      }
   }
