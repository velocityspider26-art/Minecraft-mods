...
public class LargeRadarMissileProjectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public static LargeRadarMissileProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      LargeRadarMissileProjectileEntity entityarrow = new LargeRadarMissileProjectileEntity(
         (EntityType<? extends LargeRadarMissileProjectileEntity>)CrustyChunksModEntities.LARGE_RADAR_MISSILE_PROJECTILE.get(), entity, world
      );
   ...
   public static LargeRadarMissileProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      LargeRadarMissileProjectileEntity entityarrow = new LargeRadarMissileProjectileEntity(
         (EntityType<? extends LargeRadarMissileProjectileEntity>)CrustyChunksModEntities.LARGE_RADAR_MISSILE_PROJECTILE.get(), entity, entity.level()
      );
