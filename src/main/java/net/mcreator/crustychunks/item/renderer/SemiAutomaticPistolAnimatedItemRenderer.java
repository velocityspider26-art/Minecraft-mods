...
import net.mcreator.crustychunks.item.model.SemiAutomaticPistolAnimatedItemModel;
...
public class SemiAutomaticPistolAnimatedItemRenderer extends GeoItemRenderer<SemiAutomaticPistolAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected SemiAutomaticPistolAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public SemiAutomaticPistolAnimatedItemRenderer() {
      super(new SemiAutomaticPistolAnimatedItemModel());
   }

   public RenderType getRenderType(SemiAutomaticPistolAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(SemiAutomaticPistolAnimatedItem instance) {
