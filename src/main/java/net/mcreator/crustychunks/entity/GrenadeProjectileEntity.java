...
public class GrenadeProjectileEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModItems.GRENADE.get());
   ...
   public static GrenadeProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      GrenadeProjectileEntity entityarrow = new GrenadeProjectileEntity(
         (EntityType<? extends GrenadeProjectileEntity>)CrustyChunksModEntities.GRENADE_PROJECTILE.get(), entity, world
      );
   ...
   public static GrenadeProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      GrenadeProjectileEntity entityarrow = new GrenadeProjectileEntity(
         (EntityType<? extends GrenadeProjectileEntity>)CrustyChunksModEntities.GRENADE_PROJECTILE.get(), entity, entity.level()
      );
