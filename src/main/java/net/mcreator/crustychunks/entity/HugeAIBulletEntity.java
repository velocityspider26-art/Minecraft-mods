...
public class HugeAIBulletEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModItems.TINYPROJECTILE_ITEM.get());

   public HugeAIBulletEntity(EntityType<? extends HugeAIBulletEntity> type, Level world) {
      super(type, world);
   }

   public HugeAIBulletEntity(EntityType<? extends HugeAIBulletEntity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world, PROJECTILE_ITEM.copy(), null);
   }

   public HugeAIBulletEntity(EntityType<? extends HugeAIBulletEntity> type, LivingEntity entity, Level world) {
   ...
   public static HugeAIBulletEntity shoot(Level world, LivingEntity entity, RandomSource source) {
      return shoot(world, entity, source, 1.0F, 5.0, 5);
   }

   public static HugeAIBulletEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
      return shoot(world, entity, source, pullingPower * 1.0F, 5.0, 5);
   }

   public static HugeAIBulletEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      HugeAIBulletEntity entityarrow = new HugeAIBulletEntity(
         (EntityType<? extends HugeAIBulletEntity>)CrustyChunksModEntities.HUGE_AI_BULLET.get(), entity, world
      );
   ...
   public static HugeAIBulletEntity shoot(LivingEntity entity, LivingEntity target) {
      HugeAIBulletEntity entityarrow = new HugeAIBulletEntity(
         (EntityType<? extends HugeAIBulletEntity>)CrustyChunksModEntities.HUGE_AI_BULLET.get(), entity, entity.level()
      );
