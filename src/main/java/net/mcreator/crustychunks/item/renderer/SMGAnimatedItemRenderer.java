...
import net.mcreator.crustychunks.item.model.SMGAnimatedItemModel;
...
public class SMGAnimatedItemRenderer extends GeoItemRenderer<SMGAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected SMGAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public SMGAnimatedItemRenderer() {
      super(new SMGAnimatedItemModel());
   }

   public RenderType getRenderType(SMGAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(SMGAnimatedItem instance) {
