...
import net.mcreator.crustychunks.item.model.ScopedBreechRifleItemModel;
...
public class ScopedBreechRifleItemRenderer extends GeoItemRenderer<ScopedBreechRifleItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected ScopedBreechRifleItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public ScopedBreechRifleItemRenderer() {
      super(new ScopedBreechRifleItemModel());
   }

   public RenderType getRenderType(ScopedBreechRifleItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(ScopedBreechRifleItem instance) {
