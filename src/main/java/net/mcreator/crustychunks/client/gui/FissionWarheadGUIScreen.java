...
public class FissionWarheadGUIScreen extends AbstractContainerScreen<FissionWarheadGUIMenu> {
   private static final HashMap<String, Object> guistate = FissionWarheadGUIMenu.guistate;
   private final Level world;
   private final int x;
   private final int y;
   private final int z;
   private final Player entity;
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/screens/fission_warhead_gui.png");
   ...
   protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
      guiGraphics.drawString(this.font, Component.translatable("gui.crusty_chunks.fission_warhead_gui.label_fission_bomb"), 6, 7, -12829636, false);
   }
