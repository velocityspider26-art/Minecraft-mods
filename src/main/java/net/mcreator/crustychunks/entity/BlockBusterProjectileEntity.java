...
import net.mcreator.crustychunks.procedures.BlockBusterTickProcedure;
...
public class BlockBusterProjectileEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModBlocks.SMALL_BOMB.get());

   public BlockBusterProjectileEntity(EntityType<? extends BlockBusterProjectileEntity> type, Level world) {
      super(type, world);
   }

   public BlockBusterProjectileEntity(EntityType<? extends BlockBusterProjectileEntity> type, double x, double y, double z, Level world) {
      super(type, x, y, z, world, ItemStack.EMPTY, null);
   }

   public BlockBusterProjectileEntity(EntityType<? extends BlockBusterProjectileEntity> type, LivingEntity entity, Level world) {
   ...
   public static BlockBusterProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
      return shoot(world, entity, source, pullingPower * 1.0F, 5.0, 5);
   }

   public static BlockBusterProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      BlockBusterProjectileEntity entityarrow = new BlockBusterProjectileEntity(
         (EntityType<? extends BlockBusterProjectileEntity>)CrustyChunksModEntities.BLOCK_BUSTER_PROJECTILE.get(), entity, world
      );
   ...
   public static BlockBusterProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      BlockBusterProjectileEntity entityarrow = new BlockBusterProjectileEntity(
         (EntityType<? extends BlockBusterProjectileEntity>)CrustyChunksModEntities.BLOCK_BUSTER_PROJECTILE.get(), entity, entity.level()
      );
