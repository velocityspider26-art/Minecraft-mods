...
public class MusketActionProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
      if (entity != null) {
         ...
         if (itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getBoolean("action")) {
            ...
            if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof MusketItem) {
            ...
            CrustyChunksMod.queueServerWork(
               ...
               () -> {
                  ...
                  CustomData.update(DataComponents.CUSTOM_DATA, itemstack, _tagupd -> _tagupd.putDouble("misfire", (double)Mth.nextInt(RandomSource.create(), 1, 7)));
               }
            );
         }
      }
