...
import net.mcreator.crustychunks.item.model.PumpActionShotgunAnimatedItemModel;
...
public class PumpActionShotgunAnimatedItemRenderer extends GeoItemRenderer<PumpActionShotgunAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected PumpActionShotgunAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public PumpActionShotgunAnimatedItemRenderer() {
      super(new PumpActionShotgunAnimatedItemModel());
   }

   public RenderType getRenderType(PumpActionShotgunAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(PumpActionShotgunAnimatedItem instance) {
