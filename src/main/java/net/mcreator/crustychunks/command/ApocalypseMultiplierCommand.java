...
public class ApocalypseMultiplierCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register(
            (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("WariumApocalypseMultiplier").requires(s -> s.hasPermission(4)))
               .then(Commands.argument("multiplier", DoubleArgumentType.doubleArg(0.0, 64.0)).executes(arguments -> {
                  ...
                  ApocalypseSetMultiplierProcedure.execute(world, arguments, entity);
                  return 0;
               }))
         );
   }
