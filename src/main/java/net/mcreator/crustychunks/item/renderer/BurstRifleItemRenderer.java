...
import net.mcreator.crustychunks.item.model.BurstRifleItemModel;
...
public class BurstRifleItemRenderer extends GeoItemRenderer<BurstRifleItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected BurstRifleItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public BurstRifleItemRenderer() {
      super(new BurstRifleItemModel());
   }

   public RenderType getRenderType(BurstRifleItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(BurstRifleItem instance) {
