...
public class GiantShockExplosionBypassEntity extends AbstractArrow implements ItemSupplier {
   ...
   public static GiantShockExplosionBypassEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      GiantShockExplosionBypassEntity entityarrow = new GiantShockExplosionBypassEntity(
         (EntityType<? extends GiantShockExplosionBypassEntity>)CrustyChunksModEntities.GIANT_SHOCK_EXPLOSION_BYPASS.get(), entity, world
      );
   ...
   public static GiantShockExplosionBypassEntity shoot(LivingEntity entity, LivingEntity target) {
      GiantShockExplosionBypassEntity entityarrow = new GiantShockExplosionBypassEntity(
         (EntityType<? extends GiantShockExplosionBypassEntity>)CrustyChunksModEntities.GIANT_SHOCK_EXPLOSION_BYPASS.get(), entity, entity.level()
      );
