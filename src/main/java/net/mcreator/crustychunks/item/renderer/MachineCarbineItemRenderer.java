...
import net.mcreator.crustychunks.item.model.MachineCarbineItemModel;
...
public class MachineCarbineItemRenderer extends GeoItemRenderer<MachineCarbineItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected MachineCarbineItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public MachineCarbineItemRenderer() {
      super(new MachineCarbineItemModel());
   }

   public RenderType getRenderType(MachineCarbineItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(MachineCarbineItem instance) {
