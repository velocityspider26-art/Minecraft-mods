...
import net.mcreator.crustychunks.item.model.SingleShotRifleItemModel;
...
public class SingleShotRifleItemRenderer extends GeoItemRenderer<SingleShotRifleItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected SingleShotRifleItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public SingleShotRifleItemRenderer() {
      super(new SingleShotRifleItemModel());
   }

   public RenderType getRenderType(SingleShotRifleItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(SingleShotRifleItem instance) {
