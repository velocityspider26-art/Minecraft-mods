...
import net.mcreator.crustychunks.item.renderer.BreechRifleItemRenderer;
...
public class BreechRifleItem extends Item implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   public String animationprocedure = "empty";
   String prevAnim = "empty";

   public BreechRifleItem() {
   ...
   public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
      consumer.accept(new GeoRenderProvider() {
         private BreechRifleItemRenderer renderer;

         @Override
         public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
            if (this.renderer == null)
               this.renderer = new BreechRifleItemRenderer();
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
               return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? (ArmPose) net.mcreator.crustychunks.client.pose.BreechRifleItemPose.ARM_POSE.getValue() : ArmPose.EMPTY;
            }
