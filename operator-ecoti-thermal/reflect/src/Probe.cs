...
namespace OperatorEcotiThermal.Reflect
{
    ...
    internal static class Probe
    {
        ...
        /// <summary>
        /// Find a component under <paramref name="root"/> by short type name.
        ///
        /// Routed through U so this file carries no compile-time UnityEngine dependency — that is
        /// the whole constraint this build is written under.
        /// </summary>
        public static object FindComponent(object root, string typeName)
        {
            ...
            return U.FindComponentInChildren(root, shortName);
        }
