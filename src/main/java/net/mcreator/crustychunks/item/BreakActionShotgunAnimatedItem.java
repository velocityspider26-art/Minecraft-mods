...
import net.mcreator.crustychunks.item.renderer.BreakActionShotgunAnimatedItemRenderer;
import net.mcreator.crustychunks.procedures.AmmoCount2Procedure;
...
public class BreakActionShotgunAnimatedItem extends Item implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   public String animationprocedure = "empty";
   String prevAnim = "empty";

   public BreakActionShotgunAnimatedItem() {
   ...
   public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
      consumer.accept(new GeoRenderProvider() {
         private BreakActionShotgunAnimatedItemRenderer renderer;

         @Override
         public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
            if (this.renderer == null)
               this.renderer = new BreakActionShotgunAnimatedItemRenderer();
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
               return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? (ArmPose) net.mcreator.crustychunks.client.pose.BreakActionShotgunAnimatedItemPose.ARM_POSE.getValue() : ArmPose.EMPTY;
            }
   ...
   public void appendHoverText(ItemStack itemstack, net.minecraft.world.item.Item.TooltipContext level, List<Component> list, TooltipFlag flag) {
      ...
      String hoverText = AmmoCount2Procedure.execute(itemstack);
      if (hoverText != null) {
   ...
   public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
      ...
      BreakActionFireScriptProcedure.execute(world, x, y, z, entity, itemstack);
      return ar;
   }
