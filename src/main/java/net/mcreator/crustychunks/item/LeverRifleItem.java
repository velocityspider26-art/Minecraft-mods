...
import net.mcreator.crustychunks.item.renderer.LeverRifleItemRenderer;
import net.mcreator.crustychunks.procedures.AmmoCount10Procedure;
...
public class LeverRifleItem extends Item implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   public String animationprocedure = "empty";
   String prevAnim = "empty";

   public LeverRifleItem() {
   ...
   public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
      consumer.accept(new GeoRenderProvider() {
         private LeverRifleItemRenderer renderer;

         @Override
         public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
            if (this.renderer == null)
               this.renderer = new LeverRifleItemRenderer();
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
               return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? (ArmPose) net.mcreator.crustychunks.client.pose.LeverRifleItemPose.ARM_POSE.getValue() : ArmPose.EMPTY;
            }
   ...
   public void appendHoverText(ItemStack itemstack, net.minecraft.world.item.Item.TooltipContext level, List<Component> list, TooltipFlag flag) {
      ...
      String hoverText = AmmoCount10Procedure.execute(itemstack);
      if (hoverText != null) {
   ...
   public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
      ...
      LeverGunFireScriptProcedure.execute(world, x, y, z, entity, itemstack);
      return ar;
   }
