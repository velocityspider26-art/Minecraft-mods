...
public class AutoPistolFireScriptProcedure {
      ...
      if (entity != null) {
         ...
         if (entity.getData(CrustyChunksModVariables.PLAYER_VARIABLES)
            ...
            if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == ItemStack.EMPTY.getItem()) {
               recoil = Mth.nextDouble(RandomSource.create(), 2.0, 2.5);
            } else {
               recoil = Mth.nextDouble(RandomSource.create(), 3.0, 4.0);
            }

            Movementinnacuracy = 1.1;
         } else {
         ...
         if (!itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getBoolean("action")) {
            ...
            if (1.0 <= itemstack.getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("Ammo")) {
               ...
               protected void doKnockback(LivingEntity livingEntity, DamageSource damageSource) {
                  ...
                  entity.setYRot((float)((double)entity.getYRot() + Mth.nextDouble(RandomSource.create(), -1.5, 1.5)));
         ...
         net.mcreator.crustychunks.compat.WariumSafety.report("AutoPistolFireScriptProcedure.execute", _wtSafe);
      }
   }
}
