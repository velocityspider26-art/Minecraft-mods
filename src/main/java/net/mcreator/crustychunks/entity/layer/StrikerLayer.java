...
public class StrikerLayer extends GeoRenderLayer<StrikerEntity> {
   private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath("crusty_chunks", "textures/entities/strikerglow.png");
