   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
      ...
      if (immediatesourceentity != null) {
         ...
         if (1.0 == immediatesourceentity.getPersistentData().getDouble("T")) {
            FissionEffectsProcedure.execute(world, x, immediatesourceentity.getY() - 15.0, z);
         ...
         for (double var31 = (double)(1L + Math.round(xRadius)); loop < var31; loop++) {
            if (immediatesourceentity.getPersistentData().getDouble("T") / 4.0
               == (double)Math.round(immediatesourceentity.getPersistentData().getDouble("T") / 4.0)) {
               if (1 == Mth.nextInt(RandomSource.create(), 1, 4)) {
                  ...
                  if (300.0 >= immediatesourceentity.getPersistentData().getDouble("T")) {
                     ...
                     if (5.0 <= immediatesourceentity.getPersistentData().getDouble("T")) {
                        ...
                        if (30.0 <= immediatesourceentity.getPersistentData().getDouble("T")) {
                           world.addParticle(
                              ...
                              y + Mth.nextDouble(RandomSource.create(), 64.0, 70.0),
