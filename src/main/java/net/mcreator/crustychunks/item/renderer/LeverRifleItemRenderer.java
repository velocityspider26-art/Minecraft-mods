...
import net.mcreator.crustychunks.item.model.LeverRifleItemModel;
...
public class LeverRifleItemRenderer extends GeoItemRenderer<LeverRifleItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected LeverRifleItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public LeverRifleItemRenderer() {
      super(new LeverRifleItemModel());
   }

   public RenderType getRenderType(LeverRifleItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(LeverRifleItem instance) {
