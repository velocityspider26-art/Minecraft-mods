...
public class LargeSolidProjectileRenderer extends EntityRenderer<LargeSolidProjectileEntity> {
   ...
   public LargeSolidProjectileRenderer(Context context) {
      super(context);
      this.model = new Modelartilleryshell(context.bakeLayer(Modelartilleryshell.LAYER_LOCATION));
   }

   public void render(
      LargeSolidProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn
   ) {
   ...
   public ResourceLocation getTextureLocation(LargeSolidProjectileEntity entity) {
      return texture;
   }
}
