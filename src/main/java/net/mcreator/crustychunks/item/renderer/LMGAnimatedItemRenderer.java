...
import net.mcreator.crustychunks.item.model.LMGAnimatedItemModel;
...
public class LMGAnimatedItemRenderer extends GeoItemRenderer<LMGAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected LMGAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public LMGAnimatedItemRenderer() {
      super(new LMGAnimatedItemModel());
   }

   public RenderType getRenderType(LMGAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(LMGAnimatedItem instance) {
