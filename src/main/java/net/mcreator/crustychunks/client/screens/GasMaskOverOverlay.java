...
public class GasMaskOverOverlay {
   @SubscribeEvent(
   ...
   public static void eventHandler(Pre event) {
      ...
      if (GasMaskOverlayProcedure.execute(entity)) {
         event.getGuiGraphics().blit(ResourceLocation.parse("crusty_chunks:textures/screens/vig.png"), 0, 0, 0.0F, 0.0F, w, h, w, h);
      }
