...
import net.mcreator.crustychunks.item.model.SemiAutomaticRifleAnimatedItemModel;
...
public class SemiAutomaticRifleAnimatedItemRenderer extends GeoItemRenderer<SemiAutomaticRifleAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected SemiAutomaticRifleAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public SemiAutomaticRifleAnimatedItemRenderer() {
      super(new SemiAutomaticRifleAnimatedItemModel());
   }

   public RenderType getRenderType(SemiAutomaticRifleAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(SemiAutomaticRifleAnimatedItem instance) {
