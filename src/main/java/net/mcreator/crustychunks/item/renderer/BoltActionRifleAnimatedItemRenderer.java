...
import net.mcreator.crustychunks.item.model.BoltActionRifleAnimatedItemModel;
...
public class BoltActionRifleAnimatedItemRenderer extends GeoItemRenderer<BoltActionRifleAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected BoltActionRifleAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public BoltActionRifleAnimatedItemRenderer() {
      super(new BoltActionRifleAnimatedItemModel());
   }

   public RenderType getRenderType(BoltActionRifleAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(BoltActionRifleAnimatedItem instance) {
