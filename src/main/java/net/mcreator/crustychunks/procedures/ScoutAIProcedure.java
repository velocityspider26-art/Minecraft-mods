...
public class ScoutAIProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         ...
         if (1 == Mth.nextInt(RandomSource.create(), 1, 160) && (target != null && !target.isAlive() || target == null)) {
                  ...
                  () -> {
                     ...
                     for (Entity entityiteratorx : world.getEntitiesOfClass(Entity.class, new AABB(_center, _center).inflate(256.0), e -> true)
                        ...
                        if (entity.isAlive()
                           ...
                           Mob _entityx = (Mob)entityiteratorx;
                           Entity patt6055$temp = entity instanceof Mob _mobEntx ? _mobEntx.getTarget() : null;
                           if (patt6055$temp instanceof LivingEntity _entx) {
                              _entityx.setTarget(_entx);
                           }
                        }
                     }
                  }
