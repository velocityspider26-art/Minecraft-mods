...
public class EradicatorTurretEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModItems.URANIUM_ENRICHED_INGOT.get());
   ...
   public static EradicatorTurretEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      EradicatorTurretEntity entityarrow = new EradicatorTurretEntity(
         (EntityType<? extends EradicatorTurretEntity>)CrustyChunksModEntities.ERADICATOR_TURRET.get(), entity, world
      );
   ...
   public static EradicatorTurretEntity shoot(LivingEntity entity, LivingEntity target) {
      EradicatorTurretEntity entityarrow = new EradicatorTurretEntity(
         (EntityType<? extends EradicatorTurretEntity>)CrustyChunksModEntities.ERADICATOR_TURRET.get(), entity, entity.level()
      );
