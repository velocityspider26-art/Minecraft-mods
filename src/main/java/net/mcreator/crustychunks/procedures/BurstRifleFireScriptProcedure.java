...
public class BurstRifleFireScriptProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
      ...
      if (entity != null) {
         ...
         if (entity.getData(CrustyChunksModVariables.PLAYER_VARIABLES)
            ...
            recoil = Mth.nextDouble(RandomSource.create(), 1.0, 1.5);
         }
                  ...
                  if (1.0 <= (entity instanceof LivingEntity _livEntxxxx ? _livEntxxxx.getMainHandItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getDouble("Ammo")) {
                     if ((entity instanceof LivingEntity _livEntxxxxxx ? _livEntxxxxxx.getMainHandItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY).copyTag().getBoolean("Loaded")
                        ...
                        )
                      {
                        if (entity.getData(CrustyChunksModVariables.PLAYER_VARIABLES)
                           .AimDownSights) {
                           if ((entity instanceof LivingEntity _livEntxxxxxxx ? _livEntxxxxxxx.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof BurstRifleItem
                              )
                            {
                        ...
                        } else if ((entity instanceof LivingEntity _livEntxxxxxxx ? _livEntxxxxxxx.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof BurstRifleItem
                           )
                         {
         ...
         net.mcreator.crustychunks.compat.WariumSafety.report("BurstRifleFireScriptProcedure.execute", _wtSafe);
      }
   }
}
