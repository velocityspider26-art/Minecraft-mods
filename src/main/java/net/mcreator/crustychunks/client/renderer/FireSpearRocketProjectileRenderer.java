...
public class FireSpearRocketProjectileRenderer extends EntityRenderer<FireSpearRocketProjectileEntity> {
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/entities/firespear.png");
   ...
   public void render(
      FireSpearRocketProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn
   ) {
