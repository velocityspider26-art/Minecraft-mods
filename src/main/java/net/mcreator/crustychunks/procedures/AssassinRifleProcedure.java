...
public class AssassinRifleProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      ...
      if (entity != null) {
            ...
            if (!projectileLevel.isClientSide()) {
               Projectile _entityToSpawn = (new Object() {
                     public Projectile getArrow(Level level, Entity shooter, float damage, int knockback, byte piercing) {
                        AbstractArrow entityToSpawn = new AIStealthBulletEntity((EntityType<? extends AIStealthBulletEntity>)CrustyChunksModEntities.AI_STEALTH_BULLET.get(), level) {
               @Override
         ...
         net.mcreator.crustychunks.compat.WariumSafety.report("AssassinRifleProcedure.execute", _wtSafe);
      }
   }
}
