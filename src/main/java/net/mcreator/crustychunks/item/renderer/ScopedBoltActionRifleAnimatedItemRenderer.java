...
import net.mcreator.crustychunks.item.model.ScopedBoltActionRifleAnimatedItemModel;
...
public class ScopedBoltActionRifleAnimatedItemRenderer extends GeoItemRenderer<ScopedBoltActionRifleAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected ScopedBoltActionRifleAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public ScopedBoltActionRifleAnimatedItemRenderer() {
      super(new ScopedBoltActionRifleAnimatedItemModel());
   }

   public RenderType getRenderType(ScopedBoltActionRifleAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(ScopedBoltActionRifleAnimatedItem instance) {
