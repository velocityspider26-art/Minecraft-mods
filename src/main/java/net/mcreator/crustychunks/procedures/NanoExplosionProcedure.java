   ...
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      CrustyChunksMod.queueServerWork(2, () -> {
         if (world instanceof Level _levelxx && !_levelxx.isClientSide()) {
            net.mcreator.crustychunks.compat.WariumExplosions.explode(_levelxx, null, x + 0.0, y + 0.0, z + 0.0, 1.0F, ExplosionInteraction.TNT);
         }

         if (world instanceof Level _levelx && !_levelx.isClientSide()) {
            net.mcreator.crustychunks.compat.WariumExplosions.explode(_levelx, null, x + 0.0, y + 0.0, z + 0.0, 2.0F, ExplosionInteraction.NONE);
         }
      });
