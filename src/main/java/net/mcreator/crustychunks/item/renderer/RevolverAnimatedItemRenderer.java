...
public class RevolverAnimatedItemRenderer extends GeoItemRenderer<RevolverAnimatedItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected RevolverAnimatedItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public RevolverAnimatedItemRenderer() {
      super(new RevolverAnimatedItemModel());
   }

   public RenderType getRenderType(RevolverAnimatedItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(RevolverAnimatedItem instance) {
