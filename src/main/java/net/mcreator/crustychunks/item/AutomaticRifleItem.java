...
import net.mcreator.crustychunks.item.renderer.AutomaticRifleItemRenderer;
import net.mcreator.crustychunks.procedures.AmmoCount30Procedure;
import net.mcreator.crustychunks.procedures.AutoRifleDoubleFireProcedure;
import net.mcreator.crustychunks.procedures.AutoRifleHandTickProcedure;
...
public class AutomaticRifleItem extends Item implements GeoItem {
   ...
   public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
      consumer.accept(new GeoRenderProvider() {
         private AutomaticRifleItemRenderer renderer;

         @Override
         public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
            if (this.renderer == null)
               this.renderer = new AutomaticRifleItemRenderer();
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
               return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? (ArmPose) net.mcreator.crustychunks.client.pose.AutomaticRifleItemPose.ARM_POSE.getValue() : ArmPose.EMPTY;
            }
   ...
   public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
      ...
      AutoRifleDoubleFireProcedure.execute(world, x, y, z, entity, itemstack);
      return ar;
   }
   ...
   public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
      ...
      if (selected) {
         AutoRifleHandTickProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
      }
   }
}
