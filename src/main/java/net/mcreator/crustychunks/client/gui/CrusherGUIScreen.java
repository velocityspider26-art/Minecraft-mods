...
public class CrusherGUIScreen extends AbstractContainerScreen<CrusherGUIMenu> {
   ...
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/screens/crusher_gui.png");
   ...
   protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
      ...
      guiGraphics.blit(
         ResourceLocation.parse("crusty_chunks:textures/screens/graygear.png"), this.leftPos + 4, this.topPos + 4, 0.0F, 0.0F, 16, 16, 16, 16
      );
