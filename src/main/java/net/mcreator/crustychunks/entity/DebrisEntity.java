...
import net.mcreator.crustychunks.procedures.DebrisHitProcedure;
import net.mcreator.crustychunks.procedures.DebrisTrailProcedure;
...
public class DebrisEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack(Blocks.COBBLESTONE);

   public DebrisEntity(EntityType<? extends DebrisEntity> type, Level world) {
      super(type, world);
   }
   ...
   public void tick() {
      super.tick();
      DebrisTrailProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
      if (this.inGround) {
         this.discard();
      }
   }

   public static DebrisEntity shoot(Level world, LivingEntity entity, RandomSource source) {
      return shoot(world, entity, source, 1.0F, 5.0, 5);
   }

   public static DebrisEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
      return shoot(world, entity, source, pullingPower * 1.0F, 5.0, 5);
   }

   public static DebrisEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      DebrisEntity entityarrow = new DebrisEntity((EntityType<? extends DebrisEntity>)CrustyChunksModEntities.DEBRIS.get(), entity, world);
   ...
   public static DebrisEntity shoot(LivingEntity entity, LivingEntity target) {
      DebrisEntity entityarrow = new DebrisEntity((EntityType<? extends DebrisEntity>)CrustyChunksModEntities.DEBRIS.get(), entity, entity.level());
