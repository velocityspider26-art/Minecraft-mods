...
public class TestShipHelper {
    ...
    /** Moves a construct above the Kármán line so PlanetToSpaceTeleporter sends it into 3D space (great_unknown). */
    public static void moveConstructAboveKarman(ServerLevel level, AeronauticsConstruct construct) {
