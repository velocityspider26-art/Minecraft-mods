...
public class IRMissileRenderer extends EntityRenderer<IRMissileEntity> {
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/entities/irmissilerocket.png");
   private final ModelIRGuidedRocket model;

   public IRMissileRenderer(Context context) {
      super(context);
      this.model = new ModelIRGuidedRocket(context.bakeLayer(ModelIRGuidedRocket.LAYER_LOCATION));
   }
