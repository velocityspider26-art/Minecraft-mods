...
public class StrikeSpearProjectileRenderer extends EntityRenderer<StrikeSpearProjectileEntity> {
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/entities/strikespear.png");
   private final ModelFireSpearRocket_Converted model;

   public StrikeSpearProjectileRenderer(Context context) {
      super(context);
      this.model = new ModelFireSpearRocket_Converted(context.bakeLayer(ModelFireSpearRocket_Converted.LAYER_LOCATION));
   }

   public void render(
      StrikeSpearProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn
   ) {
   ...
   public ResourceLocation getTextureLocation(StrikeSpearProjectileEntity entity) {
      return texture;
   }
}
