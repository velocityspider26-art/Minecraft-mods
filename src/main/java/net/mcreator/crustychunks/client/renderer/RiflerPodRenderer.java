...
public class RiflerPodRenderer extends EntityRenderer<RiflerPodEntity> {
   ...
   public RiflerPodRenderer(Context context) {
      super(context);
      this.model = new ModelFissionBomb(context.bakeLayer(ModelFissionBomb.LAYER_LOCATION));
   }

   public void render(RiflerPodEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(RiflerPodEntity entity) {
      return texture;
   }
}
