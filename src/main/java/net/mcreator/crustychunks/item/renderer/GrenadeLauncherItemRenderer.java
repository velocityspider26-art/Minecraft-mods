...
import net.mcreator.crustychunks.item.model.GrenadeLauncherItemModel;
...
public class GrenadeLauncherItemRenderer extends GeoItemRenderer<GrenadeLauncherItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected GrenadeLauncherItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public GrenadeLauncherItemRenderer() {
      super(new GrenadeLauncherItemModel());
   }

   public RenderType getRenderType(GrenadeLauncherItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(GrenadeLauncherItem instance) {
