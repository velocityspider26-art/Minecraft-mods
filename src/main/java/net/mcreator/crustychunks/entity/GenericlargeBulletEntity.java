...
public class GenericlargeBulletEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModItems.TINYPROJECTILE_ITEM.get());

   public GenericlargeBulletEntity(EntityType<? extends GenericlargeBulletEntity> type, Level world) {
      super(type, world);
   }
   ...
   public static GenericlargeBulletEntity shoot(Level world, LivingEntity entity, RandomSource source) {
      return shoot(world, entity, source, 5.0F, 10.0, 5);
   }

   public static GenericlargeBulletEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
      return shoot(world, entity, source, pullingPower * 5.0F, 10.0, 5);
   }

   public static GenericlargeBulletEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      GenericlargeBulletEntity entityarrow = new GenericlargeBulletEntity(
         (EntityType<? extends GenericlargeBulletEntity>)CrustyChunksModEntities.GENERICLARGE_BULLET.get(), entity, world
      );
   ...
   public static GenericlargeBulletEntity shoot(LivingEntity entity, LivingEntity target) {
      GenericlargeBulletEntity entityarrow = new GenericlargeBulletEntity(
         (EntityType<? extends GenericlargeBulletEntity>)CrustyChunksModEntities.GENERICLARGE_BULLET.get(), entity, entity.level()
      );
