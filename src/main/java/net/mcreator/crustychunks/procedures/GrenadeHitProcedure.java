   ...
   public static void execute(LevelAccessor world, Entity immediatesourceentity) {
      ...
      if (immediatesourceentity != null) {
         if (world instanceof ServerLevel _level) {
            Entity entityToSpawn = ((EntityType)CrustyChunksModEntities.GRENADE_PROJECTILE.get())
               .spawn(
                  _level,
         ...
         for (Entity entityiterator : world.getEntitiesOfClass(Entity.class, new AABB(_center, _center).inflate(0.05), e -> true)
            ...
            .toList()) {
            if (entityiterator instanceof GrenadeProjectileEntity && entityiterator != immediatesourceentity) {
         ...
         net.mcreator.crustychunks.compat.WariumSafety.report("GrenadeHitProcedure.execute", _wtSafe);
      }
   }
}
