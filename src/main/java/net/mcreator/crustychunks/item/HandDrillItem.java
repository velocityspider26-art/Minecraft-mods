...
import net.mcreator.crustychunks.item.renderer.HandDrillItemRenderer;
import net.mcreator.crustychunks.procedures.AmmoCountFluidProcedure;
import net.mcreator.crustychunks.procedures.DrillFireScriptProcedure;
import net.mcreator.crustychunks.procedures.DrillhandTickProcedure;
...
public class HandDrillItem extends Item implements GeoItem {
   ...
   public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
      consumer.accept(new GeoRenderProvider() {
         private HandDrillItemRenderer renderer;

         @Override
         public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
            if (this.renderer == null)
               this.renderer = new HandDrillItemRenderer();
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
               return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? (ArmPose) net.mcreator.crustychunks.client.pose.HandDrillItemPose.ARM_POSE.getValue() : ArmPose.EMPTY;
            }
   ...
   public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
      ...
      DrillFireScriptProcedure.execute(entity, itemstack);
      return ar;
   }
   ...
   public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
      ...
      if (selected) {
         DrillhandTickProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), itemstack);
      }
   }
}
