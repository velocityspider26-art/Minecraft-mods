...
public class NuclearBombProjectileRenderer extends EntityRenderer<NuclearBombProjectileEntity> {
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/entities/fissionbomb.png");
   ...
   public void render(
      NuclearBombProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn
   ) {
