...
import net.mcreator.crustychunks.procedures.MediumBombTickProcedure;
...
public class MediumBombProjectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public void tick() {
      super.tick();
      MediumBombTickProcedure.execute(this.level(), this);
   }

   public static MediumBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
      return shoot(world, entity, source, 1.0F, 5.0, 5);
   }

   public static MediumBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
      return shoot(world, entity, source, pullingPower * 1.0F, 5.0, 5);
   }

   public static MediumBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      MediumBombProjectileEntity entityarrow = new MediumBombProjectileEntity(
         (EntityType<? extends MediumBombProjectileEntity>)CrustyChunksModEntities.MEDIUM_BOMB_PROJECTILE.get(), entity, world
      );
   ...
   public static MediumBombProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      MediumBombProjectileEntity entityarrow = new MediumBombProjectileEntity(
         (EntityType<? extends MediumBombProjectileEntity>)CrustyChunksModEntities.MEDIUM_BOMB_PROJECTILE.get(), entity, entity.level()
      );
