...
public class ArtilleryFireProjectileRenderer extends EntityRenderer<ArtilleryFireProjectileEntity> {
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/entities/artillerytexture.png");
   ...
   public void render(
      ArtilleryFireProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn
   ) {
