...
public class ConveyorGUIScreen extends AbstractContainerScreen<ConveyorGUIMenu> {
   private static final HashMap<String, Object> guistate = ConveyorGUIMenu.guistate;
   private final Level world;
   private final int x;
   private final int y;
   private final int z;
   private final Player entity;
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/screens/conveyor_gui.png");
