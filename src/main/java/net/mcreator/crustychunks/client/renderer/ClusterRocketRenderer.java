...
public class ClusterRocketRenderer extends EntityRenderer<ClusterRocketEntity> {
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/entities/clusterrocket.png");
   private final ModelLargeRocket model;

   public ClusterRocketRenderer(Context context) {
      super(context);
      this.model = new ModelLargeRocket(context.bakeLayer(ModelLargeRocket.LAYER_LOCATION));
   }

   public void render(ClusterRocketEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
