...
import net.mcreator.crustychunks.block.ImmunityRedSandBlock;
import net.mcreator.crustychunks.block.ImmunitySandBlock;
...
import net.mcreator.crustychunks.block.LightTurbineEngineBlock;
...
import net.mcreator.crustychunks.block.MediumBombBlock;
...
public class CrustyChunksModBlocks {
   ...
   public static final DeferredHolder<Block, Block> IMMUNITY_SAND = REGISTRY.register("immunity_sand", () -> new ImmunitySandBlock());
   public static final DeferredHolder<Block, Block> IMMUNITY_RED_SAND = REGISTRY.register("immunity_red_sand", () -> new ImmunityRedSandBlock());
