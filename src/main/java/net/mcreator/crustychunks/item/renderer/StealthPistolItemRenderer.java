...
import net.mcreator.crustychunks.item.model.StealthPistolItemModel;
...
public class StealthPistolItemRenderer extends GeoItemRenderer<StealthPistolItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected StealthPistolItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public StealthPistolItemRenderer() {
      super(new StealthPistolItemModel());
   }

   public RenderType getRenderType(StealthPistolItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(StealthPistolItem instance) {
