            ...
            if (!projectileLevel.isClientSide()) {
               Projectile _entityToSpawn = (new Object() {
                     public Projectile getArrow(Level level, float damage, int knockback) {
                        AbstractArrow entityToSpawn = new IncendiaryBottleProjectileEntity((EntityType<? extends IncendiaryBottleProjectileEntity>)CrustyChunksModEntities.INCENDIARY_BOTTLE_PROJECTILE.get(), level) {
               @Override
