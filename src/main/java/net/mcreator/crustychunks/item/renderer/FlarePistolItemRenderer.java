...
import net.mcreator.crustychunks.item.model.FlarePistolItemModel;
...
public class FlarePistolItemRenderer extends GeoItemRenderer<FlarePistolItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected FlarePistolItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public FlarePistolItemRenderer() {
      super(new FlarePistolItemModel());
   }

   public RenderType getRenderType(FlarePistolItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(FlarePistolItem instance) {
