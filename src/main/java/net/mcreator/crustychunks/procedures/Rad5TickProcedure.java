...
public class Rad5TickProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      for (Entity entityiterator : world.getEntitiesOfClass(Entity.class, new AABB(_center, _center).inflate(5.0), e -> true)
         ...
         .toList()) {
         if (1000.0 > entityiterator.getPersistentData().getDouble("Radiation")) {
            entityiterator.getPersistentData().putDouble("Radiation", entityiterator.getPersistentData().getDouble("Radiation") + 5.0);
         ...
         net.mcreator.crustychunks.compat.WariumSafety.report("Rad5TickProcedure.execute", _wtSafe);
      }
   }
}
