...
public class HugeFragmentEntity extends AbstractArrow implements ItemSupplier {
   ...
   public void onHitBlock(BlockHitResult blockHitResult) {
      ...
      HugeFragmentHitProcedure.execute(
         this.level(),
   ...
   public static HugeFragmentEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      HugeFragmentEntity entityarrow = new HugeFragmentEntity(
         (EntityType<? extends HugeFragmentEntity>)CrustyChunksModEntities.HUGE_FRAGMENT.get(), entity, world
      );
   ...
   public static HugeFragmentEntity shoot(LivingEntity entity, LivingEntity target) {
      HugeFragmentEntity entityarrow = new HugeFragmentEntity(
         (EntityType<? extends HugeFragmentEntity>)CrustyChunksModEntities.HUGE_FRAGMENT.get(), entity, entity.level()
      );
