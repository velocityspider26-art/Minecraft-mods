...
public class FuelTankModuleOnTickUpdateProcedure {
      ...
      for (int index0 = 0; index0 < 3; index0++) {
         ...
         for (int index1 = 0; index1 < 3; index1++) {
            ...
            for (int index2 = 0; index2 < 3; index2++) {
               if ((0.0 != sx || 0.0 != sy || 0.0 != sz)
                  && (
                     world.getBlockState(BlockPos.containing(x + sx, y + sy, z + sz)).getBlock() == CrustyChunksModBlocks.DAMAGEDFUELTANK.get()
                        || world.getBlockState(BlockPos.containing(x + sx, y + sy, z + sz)).getBlock() == CrustyChunksModBlocks.FUEL_TANK.get()
                        || world.getBlockState(BlockPos.containing(x + sx, y + sy, z + sz)).getBlock() == CrustyChunksModBlocks.FUEL_TANK_MODULE.get()
                  )) {
   ...
   if (capability != null) _retval.set(capability.getFluidInTank(tank).getAmount());
                                          ...
                                          .getFluidTankLevel(
                                             world,
                                             BlockPos.containing(x + sx, y + sy, z + sz),
                                             (new Object() {
                                                   public int getBlockTanks(LevelAccessor level, BlockPos pos) {
                                                      AtomicInteger _retval = new AtomicInteger(0);
                                                      BlockEntity _ent = level.getBlockEntity(pos);
   ...
   if (capability != null) _retval.set(capability.drain(amount, FluidAction.SIMULATE).getAmount());
                                    ...
                                    int _amount = (int)(fillamount / 2.0);
                                    if (_ent != null) {
                                       {
   IFluidHandler capability = WariumCaps.fluid(_ent, null).orElse(null);
   if (capability != null) capability.drain(_amount, FluidAction.EXECUTE);
                                    ...
                                    _amount = (int)(fillamount / 2.0);
                                    if (_ent != null) {
                                       {
   IFluidHandler capability = WariumCaps.fluid(_ent, null).orElse(null);
   if (capability != null) capability.fill(
                                                   new FluidStack((Fluid)CrustyChunksModFluids.LIQUID_HYDROGEN.get(), _amount), FluidAction.EXECUTE
                                                )
                                          ;
}
                                    }
   ...
   if (capability != null) _retval.set(capability.getFluidInTank(tank).getAmount());
                                    ...
                                    .getFluidTankLevel(world, BlockPos.containing(x + sx, y + sy, z + sz), (new Object() {
                                       public int getBlockTanks(LevelAccessor level, BlockPos pos) {
                                          AtomicInteger _retval = new AtomicInteger(0);
                                          BlockEntity _ent = level.getBlockEntity(pos);
                                          if (_ent != null) {
   ...
   if (capability != null) _retval.set(
                                                         capability.fill(
                                                            new FluidStack((Fluid)CrustyChunksModFluids.LIQUID_OXYGEN.get(), amount), FluidAction.SIMULATE
                                                         )
                                                      )
                                                ;
}
   ...
   if (capability != null) _retval.set(capability.drain(amount, FluidAction.SIMULATE).getAmount());
                                 ...
                                 int _amountx = (int)(fillamount / 2.0);
                                 if (_entx != null) {
                                    {
   ...
   if (capability != null) capability.drain(_amountx, FluidAction.EXECUTE);
                                 ...
                                 _amountx = (int)(fillamount / 2.0);
                                 if (_entx != null) {
                                    {
   IFluidHandler capability = WariumCaps.fluid(_entx, null).orElse(null);
   if (capability != null) capability.fill(
                                                new FluidStack((Fluid)CrustyChunksModFluids.LIQUID_OXYGEN.get(), _amountx), FluidAction.EXECUTE
                                             )
                                       ;
}
                                 }
   ...
   if (capability != null) _retval.set(
                                                      capability.fill(
                                                         new FluidStack((Fluid)CrustyChunksModFluids.HYDRAZINE.get(), amount), FluidAction.SIMULATE
                                                      )
                                                   )
                                             ;
}
   ...
   if (capability != null) _retval.set(capability.drain(amount, FluidAction.SIMULATE).getAmount());
                              ...
                              int _amountxx = (int)(fillamount / 2.0);
                              if (_entxx != null) {
                                 {
   ...
   if (capability != null) _retval.set(capability.drain(amount, FluidAction.SIMULATE).getAmount());
                           ...
                           int _amountxxx = (int)(fillamount / 2.0);
                           if (_entxxx != null) {
                              {
   ...
   if (capability != null) _retval.set(capability.drain(amount, FluidAction.SIMULATE).getAmount());
                        ...
                        int _amountxxxx = (int)(fillamount / 2.0);
                        if (_entxxxx != null) {
                           {
   ...
   if (capability != null) capability.drain(_amountxxxx, FluidAction.EXECUTE);
                        ...
                        _amountxxxx = (int)(fillamount / 2.0);
                        if (_entxxxx != null) {
                           {
   IFluidHandler capability = WariumCaps.fluid(_entxxxx, null).orElse(null);
   ...
   if (capability != null) _retval.set(capability.drain(amount, FluidAction.SIMULATE).getAmount());
                     ...
                     int _amountxxxxx = (int)(fillamount / 2.0);
                     if (_entxxxxx != null) {
                        {
   ...
   if (capability != null) capability.drain(_amountxxxxx, FluidAction.EXECUTE);
                     ...
                     _amountxxxxx = (int)(fillamount / 2.0);
                     if (_entxxxxx != null) {
                        {
   IFluidHandler capability = WariumCaps.fluid(_entxxxxx, null).orElse(null);
   if (capability != null) capability.fill(new FluidStack((Fluid)CrustyChunksModFluids.KEROSENE.get(), _amountxxxxx), FluidAction.EXECUTE);
         ...
         net.mcreator.crustychunks.compat.WariumSafety.report("FuelTankModuleOnTickUpdateProcedure.execute", _wtSafe);
      }
   }
}
