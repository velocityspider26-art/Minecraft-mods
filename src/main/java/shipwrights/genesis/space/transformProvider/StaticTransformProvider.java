...
public class StaticTransformProvider implements CelestialTransformProvider {
    ...
    public static final MapCodec<StaticTransformProvider> MAP_CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(
    ...
    public static final Codec<StaticTransformProvider> CODEC = MAP_CODEC.codec();
