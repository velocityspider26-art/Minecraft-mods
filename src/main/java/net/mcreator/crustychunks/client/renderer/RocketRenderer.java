...
public class RocketRenderer extends EntityRenderer<RocketEntity> {
   private static final ResourceLocation texture = ResourceLocation.parse("crusty_chunks:textures/entities/armorpeelerrocket.png");
   private final ModelArmorPeelerRocket_Converted model;

   public RocketRenderer(Context context) {
      super(context);
      this.model = new ModelArmorPeelerRocket_Converted(context.bakeLayer(ModelArmorPeelerRocket_Converted.LAYER_LOCATION));
   }

   public void render(RocketEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
