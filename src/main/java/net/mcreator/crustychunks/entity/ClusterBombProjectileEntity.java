...
public class ClusterBombProjectileEntity extends AbstractArrow implements ItemSupplier {
   public static final ItemStack PROJECTILE_ITEM = new ItemStack((ItemLike)CrustyChunksModItems.HE_PROJECTILE.get());

   public ClusterBombProjectileEntity(EntityType<? extends ClusterBombProjectileEntity> type, Level world) {
      super(type, world);
   }
   ...
   public static ClusterBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
      return shoot(world, entity, source, 1.0F, 5.0, 5);
   }

   public static ClusterBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
      return shoot(world, entity, source, pullingPower * 1.0F, 5.0, 5);
   }

   public static ClusterBombProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      ClusterBombProjectileEntity entityarrow = new ClusterBombProjectileEntity(
         (EntityType<? extends ClusterBombProjectileEntity>)CrustyChunksModEntities.CLUSTER_BOMB_PROJECTILE.get(), entity, world
      );
   ...
   public static ClusterBombProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      ClusterBombProjectileEntity entityarrow = new ClusterBombProjectileEntity(
         (EntityType<? extends ClusterBombProjectileEntity>)CrustyChunksModEntities.CLUSTER_BOMB_PROJECTILE.get(), entity, entity.level()
      );
