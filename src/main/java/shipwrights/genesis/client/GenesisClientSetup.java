...
import shipwrights.genesis.hyperspace.HyperdriveScreen;
...
public class GenesisClientSetup {
    ...
    public static void onRegisterReloadListeners(RegisterClientReloadListenersEvent event) {
        ...
        event.registerReloadListener(new SimplePreparableReloadListener<Void>() {
            ...
            protected void apply(@NotNull Void object, @NotNull ResourceManager resourceManager, @NotNull ProfilerFiller profiler) {
                ...
                GenesisMod.LOGGER.debug("Cleared planet texture and voxel GPU caches");
            }
        });
    }
    ...
    public static void registerMenuScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(GenesisBlocks.HYPERDRIVE_MENU.get(), HyperdriveScreen::new);
    }

    @SubscribeEvent
    public static void registerGuiLayers(RegisterGuiLayersEvent event) {
        event.registerAboveAll(
                ResourceLocation.fromNamespaceAndPath(GenesisMod.MOD_ID, "hyperspace_tunnel"),
                HyperspaceTunnelRenderer::renderOverlay
        );
    }
