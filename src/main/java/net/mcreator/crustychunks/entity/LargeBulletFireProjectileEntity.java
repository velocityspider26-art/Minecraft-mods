...
public class LargeBulletFireProjectileEntity extends AbstractArrow implements ItemSupplier {
   ...
   public static LargeBulletFireProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
      LargeBulletFireProjectileEntity entityarrow = new LargeBulletFireProjectileEntity(
         (EntityType<? extends LargeBulletFireProjectileEntity>)CrustyChunksModEntities.LARGE_BULLET_FIRE_PROJECTILE.get(), entity, world
      );
   ...
   public static LargeBulletFireProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
      LargeBulletFireProjectileEntity entityarrow = new LargeBulletFireProjectileEntity(
         (EntityType<? extends LargeBulletFireProjectileEntity>)CrustyChunksModEntities.LARGE_BULLET_FIRE_PROJECTILE.get(), entity, entity.level()
      );
