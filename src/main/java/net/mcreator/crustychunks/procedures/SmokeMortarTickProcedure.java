...
public class SmokeMortarTickProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity immediatesourceentity) {
      ...
      if (immediatesourceentity != null) {
         ...
         if (immediatesourceentity.getPersistentData().getDouble("T") >= 20.0 && world instanceof Level _level) {
            if (!_level.isClientSide()) {
               _level.playSound(
                  ...
                  (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("intentionally_empty")),
                  SoundSource.NEUTRAL,
                  2.0F,
         ...
         net.mcreator.crustychunks.compat.WariumSafety.report("SmokeMortarTickProcedure.execute", _wtSafe);
      }
   }
}
