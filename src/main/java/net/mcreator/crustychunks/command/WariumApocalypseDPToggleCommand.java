...
public class WariumApocalypseDPToggleCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register(
            (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("WariumApocalypseDynamicProduction").requires(s -> s.hasPermission(4)))
               .then(Commands.argument("Toggle", BoolArgumentType.bool()).executes(arguments -> {
                  ...
                  DPToggleProcedure.execute(world, arguments, entity);
                  return 0;
               }))
         );
   }
