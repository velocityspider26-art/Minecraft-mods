...
import net.mcreator.crustychunks.item.renderer.PumpActionShotgunAnimatedItemRenderer;
...
import net.mcreator.crustychunks.procedures.ShotgunActionScriptProcedure;
...
public class PumpActionShotgunAnimatedItem extends Item implements GeoItem {
   private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
   public String animationprocedure = "empty";
   String prevAnim = "empty";

   public PumpActionShotgunAnimatedItem() {
   ...
   public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
      consumer.accept(new GeoRenderProvider() {
         private PumpActionShotgunAnimatedItemRenderer renderer;

         @Override
         public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
            if (this.renderer == null)
               this.renderer = new PumpActionShotgunAnimatedItemRenderer();
   ...
   public void initializeClient(Consumer<IClientItemExtensions> consumer) {
      ...
      consumer.accept(new IClientItemExtensions() {
         public ArmPose getArmPose(LivingEntity entityLiving, InteractionHand hand, ItemStack itemStack) {
               return !itemStack.isEmpty() && entityLiving.getUsedItemHand() == hand ? (ArmPose) net.mcreator.crustychunks.client.pose.PumpActionShotgunAnimatedItemPose.ARM_POSE.getValue() : ArmPose.EMPTY;
            }
   ...
   public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
      ...
      ShotgunFireScriptProcedure.execute(world, x, y, z, entity, itemstack);
      return ar;
   }

   public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
      boolean retval = super.onEntitySwing(itemstack, entity);
      ShotgunActionScriptProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
      return retval;
   }
