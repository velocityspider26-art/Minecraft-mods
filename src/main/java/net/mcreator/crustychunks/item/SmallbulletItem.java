...
public class SmallbulletItem extends Item {
   ...
   public void appendHoverText(ItemStack itemstack, net.minecraft.world.item.Item.TooltipContext level, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.translatable("item.crusty_chunks.smallbullet.description_0"));
      list.add(Component.translatable("item.crusty_chunks.smallbullet.description_1"));
   }
}
