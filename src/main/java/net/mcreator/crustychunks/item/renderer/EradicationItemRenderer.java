...
import net.mcreator.crustychunks.item.model.EradicationItemModel;
...
public class EradicationItemRenderer extends GeoItemRenderer<EradicationItem> {
   private static final float SCALE_RECIPROCAL = 0.0625F;
   protected boolean renderArms = false;
   protected MultiBufferSource currentBuffer;
   protected RenderType renderType;
   public ItemDisplayContext transformType;
   protected EradicationItem animatable;
   private final Set<String> hiddenBones = new HashSet<>();
   private final Set<String> suppressedBones = new HashSet<>();

   public EradicationItemRenderer() {
      super(new EradicationItemModel());
   }

   public RenderType getRenderType(EradicationItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
   ...
   public ResourceLocation getTextureLocation(EradicationItem instance) {
