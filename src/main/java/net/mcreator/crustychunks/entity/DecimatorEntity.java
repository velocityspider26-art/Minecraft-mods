...
import net.mcreator.crustychunks.procedures.DecimatorAISystemProcedure;
import net.mcreator.crustychunks.procedures.DecimatorDeathProcedure;
...
public class DecimatorEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DecimatorEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DecimatorEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DecimatorEntity.class, EntityDataSerializers.STRING);
   ...
   public DecimatorEntity(EntityType<DecimatorEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   protected void defineSynchedData(SynchedEntityData.Builder builder) {
      ...
      builder.define(TEXTURE, "steelgolem");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(2, new AvoidEntityGoal(this, DecimatorEntity.class, 30.0F, 1.0, 1.2));
      ...
      this.targetSelector.addGoal(10, (new HurtByTargetGoal(this) {
         public boolean canUse() {
            double x = DecimatorEntity.this.getX();
            double y = DecimatorEntity.this.getY();
            double z = DecimatorEntity.this.getZ();
            Entity entity = DecimatorEntity.this;
            Level world = DecimatorEntity.this.level();
   ...
   public void die(DamageSource source) {
      super.die(source);
      DecimatorDeathProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   }
   ...
   public void baseTick() {
      super.baseTick();
      DecimatorAISystemProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
