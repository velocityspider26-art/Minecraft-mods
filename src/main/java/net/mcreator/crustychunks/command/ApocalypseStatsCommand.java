...
public class ApocalypseStatsCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register(
            (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("WariumApocalypseStatus").requires(s -> s.hasPermission(4))).executes(arguments -> {
               ...
               ApocalypseStatsDeclareProcedure.execute(world, entity);
               return 0;
            })
         );
   }
